...
static unsigned char testCert1[] = {
...
static unsigned char testCert2[] = {
    0x30, 0x82, 0x01, 0x0A, 0x30, 0x81, 0xB7, 0xA0, 0x03, 0x02, 0x01, 0x02,
...
static char testLabel1[] = "TestCert1";
static char testLabel2[] = "TestCert2";
...
static CK_RV create_token_cert_object(CK_SESSION_HANDLE session,
                                      unsigned char* certData, CK_ULONG certLen,
                                      char* label, CK_OBJECT_HANDLE* objHandle)
{
    CK_RV ret;
