 ...
 *
 * Regression test for issue F-3851: C_Decrypt with CKM_AES_CCM must reject
 * ciphertext shorter than the configured MAC length with
 * CKR_ENCRYPTED_DATA_LEN_RANGE. Without that guard the length subtraction
 * (decDataLen = ulEncryptedDataLen - macLen) underflows.
 */
